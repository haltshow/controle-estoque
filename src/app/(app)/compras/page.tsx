            ...
            <Table>
                ...
                <TableBody>
                    ...
                    <TableRow key={id}>
                        ...
                        <TableCell>{compra.valor_unitario}</TableCell>
                        <TableCell>{compra.qtd}</TableCell>
                        {compra && compra.status == 'Aguardando entrega' && (
                            <TableCell><Badge className="bg-yellow-500 text-black font-bold">{compra.status}</Badge></TableCell>
                        )}
                        {compra && compra.status == 'Concluída' && (
                            <TableCell><Badge className="bg-green-500 text-black font-bold">{compra.status}</Badge></TableCell>
                        )}
                    </TableRow>
                    ))}
                </TableBody>
